...
import 'package:cyberdriver/features/profile/register_page.dart';
import 'package:cyberdriver/features/news/news_page.dart';
import 'package:cyberdriver/features/admin/admin_page.dart';
...
class AppRouter {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/admin':
        return NoTransitionPageRoute(builder: (_) => const AdminPage(), settings: settings);
      case '/hello':
      default:
